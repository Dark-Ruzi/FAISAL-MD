...
module.exports = {
  ...
  PACKNAME: process.env.PACKNAME || "THE PROTECTOR",
  AUTHOR: process.env.AUTHOR || "THE PROTECTOR",
  SUDO: process.env.SUDO || "919446072492,919562243683",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "",
  OWNER_NAME: process.env.OWNER_NAME || "THE PROTECTOR",
  HEROKU: toBool(process.env.HEROKU) || false,
  BOT_NAME: process.env.BOT_NAME || "FAISAL-MD",
  BOT_IMG: process.env.BOT_IMG || "https://files.catbox.moe/wtqlhp.jpg",
